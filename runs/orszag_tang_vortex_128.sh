...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/orszag_tang_vortex_128.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/orszag_tang_vortex_128.$JOB_ID.err
#
#$ -m e
