...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/loop_advection_64x128_cut.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/loop_advection_64x128_cut.$JOB_ID.err
#
#$ -m e
...
RUNID=loop_advection_64x128_cut
