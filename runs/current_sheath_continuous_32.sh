...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/current_sheath_continuous_32.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/current_sheath_continuous_32.$JOB_ID.err
#
#$ -m e
...
RUNID=current_sheath_continuous_32
