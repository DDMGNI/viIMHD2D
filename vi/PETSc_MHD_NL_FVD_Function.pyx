...
#                             + 0.5  * self.derivatives.grady_fv(Ph, ix, jx)
                ...
                y[iy, jy, 2] = self.dt(Bx,  ix, jx) \
                             - self.dt(Bxh, ix, jx) \
                             + 0.25 * self.derivatives.dy_fx_uy(Bx,  Vy,  ix, jx) \
                             + 0.25 * self.derivatives.dy_fx_uy(Bxh, Vy,  ix, jx) \
                             + 0.25 * self.derivatives.dy_fx_uy(Bx,  Vyh, ix, jx) \
                             + 0.25 * self.derivatives.dy_fx_uy(Bxh, Vyh, ix, jx) \
                             - 0.25 * self.derivatives.dy_fx_uy(Vx,  By,  ix, jx) \
                             - 0.25 * self.derivatives.dy_fx_uy(Vxh, By,  ix, jx) \
                             - 0.25 * self.derivatives.dy_fx_uy(Vx,  Byh, ix, jx) \
                             - 0.25 * self.derivatives.dy_fx_uy(Vxh, Byh, ix, jx)
                    
                # B_y
                y[iy, jy, 3] = self.dt(By,  ix, jx) \
                             - self.dt(Byh, ix, jx) \
                             + 0.25 * self.derivatives.dx_fx_uy(Vx,  By,  ix, jx) \
                             + 0.25 * self.derivatives.dx_fx_uy(Vxh, By,  ix, jx) \
                             + 0.25 * self.derivatives.dx_fx_uy(Vx,  Byh, ix, jx) \
                             + 0.25 * self.derivatives.dx_fx_uy(Vxh, Byh, ix, jx) \
                             - 0.25 * self.derivatives.dx_fx_uy(Bx,  Vy,  ix, jx) \
                             - 0.25 * self.derivatives.dx_fx_uy(Bxh, Vy,  ix, jx) \
                             - 0.25 * self.derivatives.dx_fx_uy(Bx,  Vyh, ix, jx) \
                             - 0.25 * self.derivatives.dx_fx_uy(Bxh, Vyh, ix, jx)
