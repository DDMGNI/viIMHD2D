...
#        self.fac_grdx    = 1.0 / 2. / 8. / self.hx
#        self.fac_grdy    = 1.0 / 2. / 8. / self.hy
        self.fac_grdx    = 0.5 / 2. / 8. / self.hx
        self.fac_grdy    = 0.5 / 2. / 8. / self.hy
        ...
        for i in np.arange(xs, xe):
            ...
            for j in np.arange(ys, ye):
                ...
                for index, value in [
                        ...
                        ((i+1, j+1), + 1. * self.fac_grdx),
                        ((i-1, j+1), - 1. * self.fac_grdx),
                        ((i+2, j-1), + 1. * self.fac_grdx),
                        ((i,   j-1), - 1. * self.fac_grdx),
                        ((i+2, j  ), + 2. * self.fac_grdx),
                        ((i,   j  ), - 2. * self.fac_grdx),
                        ((i+2, j+1), + 1. * self.fac_grdx),
                        ((i,   j+1), - 1. * self.fac_grdx),
                    ]:
                ...
                for index, value in [
                        ...
                        ((i+1, j+1), + 1. * self.fac_grdy),
                        ((i+1, j-1), - 1. * self.fac_grdy),
                        ((i-1, j+2), + 1. * self.fac_grdy),
                        ((i-1, j  ), - 1. * self.fac_grdy),
                        ((i,   j+2), + 2. * self.fac_grdy),
                        ((i,   j  ), - 2. * self.fac_grdy),
                        ((i+1, j+2), + 1. * self.fac_grdy),
                        ((i+1, j  ), - 1. * self.fac_grdy),
                    ]:
