...
#$ -pe impi_hydra 128
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/current_sheet_reconnection_1024512.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/current_sheet_reconnection_1024512.$JOB_ID.err
#
#$ -m e
...
mpiexec -perhost 16 -l -n 128 python3.3 inertial_mhd2d_nonlinear_newton_snes_gmres.py runs_tokp/$RUNID.cfg 
