...
#$ -pe impi_hydra 64
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/current_sheet_1024x512.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/current_sheet_1024x512.$JOB_ID.err
#
#$ -m e
...
mpiexec -perhost 16 -l -n 64 python3.3 ideal_mhd2d_nonlinear_newton_snes_gmres.py runs_tokp/$RUNID.cfg 
