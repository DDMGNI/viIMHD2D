...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viIMHD2D/current_sheet_reconnection_256x128.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viIMHD2D/current_sheet_reconnection_256x128.$JOB_ID.err
#
#$ -m e
...
RUNID=current_sheet_reconnection_256x128
