...
#        stencil = 1
        ...
        self.snes_euler.getKSP().setType('preonly')
        self.snes_euler.getKSP().getPC().setType('lu')
        ...
        self.snes_faraday.getKSP().setType('preonly')
        self.snes_faraday.getKSP().getPC().setType('lu')
        ...
        self.snes_poisson.getKSP().setType('preonly')
