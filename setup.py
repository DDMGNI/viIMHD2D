...
ext_modules = [
        ...
        Extension("PETSc_MHD_VI_CFD",
                  sources=["PETSc_MHD_VI_CFD.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
                 ),
        Extension("PETSc_MHD_VI_CFD_NL",
                  sources=["PETSc_MHD_VI_CFD_NL.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
        ...
        Extension("PETSc_MHD_VI_GAWLIK_NL",
                  sources=["PETSc_MHD_VI_GAWLIK_NL.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
