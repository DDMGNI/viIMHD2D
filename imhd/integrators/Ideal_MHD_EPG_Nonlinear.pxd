...
cdef class PETScFunction(object):
    ...
    cdef double psix_ux(self, double[:,:] A, double[:,:] Ux, double[:,:] Uy, int i, int j, double sign)
    cdef double psix_uy(self, double[:,:] A, double[:,:] Ux, double[:,:] Uy, int i, int j, double sign)
    cdef double psiy_ux(self, double[:,:] A, double[:,:] Ux, double[:,:] Uy, int i, int j, double sign)
    cdef double psiy_uy(self, double[:,:] A, double[:,:] Ux, double[:,:] Uy, int i, int j, double sign)
