        ...
        for i in np.arange(xs, xe):
            ...
            for j in np.arange(ys, ye):
                ...
                ty[iy, jy, 3] = self.derivatives.dt(Vy, ix, jx) \
                              ...
                              + 0.25 * self.dy(Bx, Bx, ix, jx) \
                              - 0.25 * self.dy(By, By, ix, jx) \
                              + 0.5 * self.derivatives.grady(P, ix, jx)
                
                # P
                ty[iy, jy, 4] = self.derivatives.laplace(P, ix, jx) \
        ...
        for i in np.arange(xs, xe):
            ...
            for j in np.arange(ys, ye):
                ...
                tVx[iy, jy] = \
                              ...
                              - 0.5 * self.dx(By, By, ix, jx)
                
                tVy[iy, jy] = \
                              - self.dx(Vx, Vy, ix, jx) \
                              - self.dy(Vy, Vy, ix, jx) \
                              + self.dx(Bx, By, ix, jx) \
                              - 0.5 * self.dy(Bx, Bx, ix, jx) \
